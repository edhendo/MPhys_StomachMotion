...
pca104 = np.load('C:\MPhys\\Data\\pca104_result_cube_non.npy')
Rpca104 = np.load('C:\MPhys\\Data\\Rpca104_result_cube_non.npy')
Xpca104 = np.load('C:\MPhys\\Data\\Xpca104_result_cube_non.npy')
Nonpca104 = np.load('C:\MPhys\\Data\\pca104_result_cube.npy')
NonRpca104 = np.load('C:\MPhys\\Data\\Rpca104_result_cube.npy')
NonXpca104 = np.load('C:\MPhys\\Data\\Xpca104_result_cube.npy')
...
multi_slice_viewer(np.rot90((pca104[:,:,:,3]),1,(1,2)))
multi_slice_viewer(np.rot90((Nonpca104[:,:,:,3]),1,(1,2)))