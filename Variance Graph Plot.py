...
stomach02 = np.load('C:\MPhys\\Data\\Intra Patient\\Stomach_Interpolated\\PCA\\EVRMag_Stomach02.npy') 
stomach04 = np.load('C:\MPhys\\Data\\Intra Patient\\Stomach_Interpolated\\PCA\\EVRMag_Stomach04.npy') 
stomach05 = np.load('C:\MPhys\\Data\\Intra Patient\\Stomach_Interpolated\\PCA\\EVRMag_Stomach05.npy') 
stomach06 = np.load('C:\MPhys\\Data\\Intra Patient\\Stomach_Interpolated\\PCA\\EVRMag_Stomach06.npy') 
stomach07 = np.load('C:\MPhys\\Data\\Intra Patient\\Stomach_Interpolated\\PCA\\EVRMag_Stomach07.npy') 
...
# plt.title('Percentage Variance for each Principal Component',fontsize = 16)
