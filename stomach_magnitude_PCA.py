...
for i in range(1,11):
    if True: #i != refScanNum: #Not needed right now since the reference scan is set to -1*averagewarp
        locals()["img"+str(i)] = nib.load('C:\MPhys\\Data\\Intra Patient\\Stomach_Interpolated\\Stomach04\\warp{0}.nii'.format(i+2))
...
np.save('C:\MPhys\\Data\\Intra Patient\\Stomach_Interpolated\\PCA\\EVRMag_Stomach04.npy',pca.explained_variance_ratio_)
...
#np.save('C:\MPhys\\Data\\PCA results\\Panc01StomachCropMagnitudePCAcube.npy', pca_result_cube)
np.save('C:\MPhys\\Data\\Intra Patient\\Stomach_Interpolated\\PCA\\pcaMagStomach04.npy', pca_result_cube)
...
plt.title('Percentage Variance - Stomach04 Mag',fontsize = 16)
...
plt.savefig('C:\MPhys\\Data\\Intra Patient\\Stomach_Interpolated\\PCA Graphs and Images\\Stomach04_VarianceMag.png')
